...
![Visual Teaser](docs/teaser_placeholder.png) 

## Full Report
For an in-depth analysis of our methodology, loss functions, evaluation metrics, and discussion on adversarial overfitting, please read our **[Full Lab Report](Report.pdf)**.

## How to Run the Attack

The attack is designed to be executed in Google Colab using our main notebook. 

1. **Open the Notebook:** Open the `final_attack.ipynb` file located in the project's main folder, using Google Colab.
